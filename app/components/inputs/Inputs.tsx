  ...
  return (
    <div className="relative w-full ">
      ...
      <input
        ...
        placeholder=""
        type={type}
        className={`peer w-full p-4 pt-6 text-base font-medium bg-white border-2 rounded-md outline-none transition disabled: opacity-70 disabled:cursor-not-allowed text-black
